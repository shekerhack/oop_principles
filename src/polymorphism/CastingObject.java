...
public class CastingObject {
    public static void main(String[] args) {
        ...
        Object object = new Cat(); // up-casting Cat in the shape of Object
        ...
        Immediate use of dow-casting is not possible, and you will get ClassCastException with that.
        DO NOT TRY IT THIS WAY
         */

        Animal a1 = new Dog(); // This is a Dog in the shape of Animal
